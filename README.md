...
Planning is the default. `--copy-to` creates a new destination through a staged directory and preserves every source file. Paths in the CSV must be relative and remain inside the selected source folder.
